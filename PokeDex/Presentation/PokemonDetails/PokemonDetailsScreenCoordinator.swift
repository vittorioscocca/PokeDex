...
/// coordinator responsabile della gestione della schermata dei dettagli del Pokémon.
///
...
/// - Gestire le azioni specifiche del coordinator tramite un publisher.
...
class PokemonDetailsScreenCoordinator: CoordinatorProtocol {
    ...
    /// coordinator dello stack di navigazione che gestisce la presentazione della schermata.
    ...
    /// Publisher che espone le azioni del coordinator come `PokemonDetailsScreenCoordinatorAction`.
    ...
    /// Inizializza il coordinator per la schermata dei dettagli del Pokémon.
    ///
    /// - Parameters:
    ///   - navigationStackCoordinator: Il coordinator dello stack di navigazione che gestisce la presentazione delle schermate.
    ...
    /// Avvia il coordinator per la schermata dei dettagli del Pokémon.
    ///
    ...
    ///
    /// Questo metodo viene utilizzato per interrompere eventuali processi gestiti dal coordinator.
    ...
    ///
    /// Il metodo invoca il metodo `toPresentable()` del coordinator dello stack di navigazione e
